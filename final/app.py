...
def linked_list_visualizer():
    ...
    linked_list.insert_at_beginning(19)
    linked_list.insert_at_beginning(20)
    linked_list.insert_at_beginning(21)
    linked_list.insert_at_beginning(22)
    linked_list.insert_at_beginning(23)
    linked_list.insert_at_beginning(24)
    linked_list.insert_at_beginning(25)
    linked_list.insert_at_beginning(26)
    linked_list.insert_at_beginning(27)
    linked_list.insert_at_beginning(28)
    linked_list.insert_at_beginning(29)
